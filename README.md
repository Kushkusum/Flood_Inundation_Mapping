...
1. Export DEM derivatives from Google Earth Engine
1. Export CHIRPS and ERA5 temporal sequences from Google Earth Engine
1. Preprocess and stack all spatial channels
1. Compute normalization statistics
1. Train U-Net spatial baseline
1. Train temporal model variants
1. Compare ablation results
1. Run Assam 2023 generalization test
1. Visualize outputs in Streamlit dashboard
